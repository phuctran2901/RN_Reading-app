...
import { layoutRank } from "../LayoutSkeleton/index";
export default function SectionRank({ listRankStory, navigation, isLoading }) {
    return (
        <SkeletonContent
            containerStyle={styles.wrapperSectionRank}
            isLoading={isLoading}
            layout={layoutRank}
        >
